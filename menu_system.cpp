...
const char* menu_names[MENU_ITEMS] = {
  "nRF24 Scanner", "nRF24 Jammer", "CC1101 Scanner",
  "CC1101 Capture", "CC1101 BruteForce", "CC1101 FreqSweep",
  "BLE Scan", "WiFi Scan", "Sour Apple", "Configuracoes"
};
